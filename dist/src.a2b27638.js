...
var colorArray = ["red", "pink", "yellow", "purple", "blue", "orange"];
var shapeArray = ["oval", "circle", "square", "rectangle"];
function ran(n) {
  return Math.floor(Math.random() * n);
}
click1.addEventListener("click", function () {
  var num = colorArray.length;
  var changeColorIndex = ran(num);
  outerdiv.style.backgroundColor = colorArray[changeColorIndex];
  console.log("color index", changeColorIndex);
});
click2.addEventListener("click", function () {
  var num = shapeArray.length;
  var shapeIndex = ran(num);
